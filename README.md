<p align="center">
    <img src="https://github.com/user-attachments/assets/a94e2198-4a6e-4b9c-835b-4317fe38d34c" alt="Description" width="700">
</p>
...
> [!TIP]
> センシティブコンテンツの場合や、プレミアム会員で動画を高画質でダウンロードしたい場合、`cookies-from-browser`オプションを使用できます\
> ニコニコにログインした状態で`--cookies-from-browser [ブラウザ名(chromeなど)]`のように指定してください
...
> [!TIP]
> ダウンロードに失敗した場合、yt-dlpのアップデートを試してみてください
> 
